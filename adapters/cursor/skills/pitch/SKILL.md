---
name: pitch
description: "Cricket /pitch. Explicit slash command. Follow the /pitch section of the shared Cricket contract. Do not apply this unless the user invokes /pitch."
disable-model-invocation: true
---

# /pitch

Cursor wiring for Cricket `/pitch`. This file does not define the behavior.
